...
export function Demo(): JSX.Element {
	...
	return (
		<div style={{ textAlign: "center", marginTop: 50 }}>
			...
			<div style={{ marginTop: 20 }}>
				<button onClick={() => setState({ animate: !animate })}>
			...
			<div style={{ marginTop: 20 }}>
				...
				<input
					onChange={(e) =>
						setState({ minZoom: Number.parseInt(e.target.value) || 1 })
					}
					value={minZoom}
					type="number"
					style={{ width: 40 }}
				...
				<input
					onChange={(e) =>
						setState({ maxZoom: Number.parseInt(e.target.value) || 18 })
					}
					value={maxZoom}
					type="number"
					style={{ width: 40 }}
			...
			<div style={{ marginTop: 20 }}>
				{Object.keys(markers).map((key) => (
					<button
						key={key}
						onClick={() =>
							setState({ center: markers[key][0], zoom: markers[key][1] })
						}
					>
						{key}
					</button>
